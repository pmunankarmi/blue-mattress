		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					...
					array( 'key' => 'field_blue_tab_email_delivery', 'label' => __( 'Email delivery', 'blue-mattress' ), 'name' => '', 'type' => 'tab' ),
					array(
						'key'          => 'field_blue_smtp_guidance',
						'label'        => __( 'Microsoft 365 SMTP', 'blue-mattress' ),
						'name'         => '',
						'type'         => 'message',
						'message'      => __( 'Uses smtp.office365.com on port 587 with STARTTLS. Authenticated SMTP must be enabled for this mailbox in Microsoft 365. This changes mail transport only; WooCommerce remains responsible for its email templates and content.', 'blue-mattress' ),
						'new_lines'    => 'wpautop',
						'esc_html'     => 1,
					),
					array(
						'key'           => 'field_blue_smtp_enabled',
						'label'         => __( 'Use Microsoft 365 SMTP', 'blue-mattress' ),
						'name'          => 'smtp_enabled',
						'type'          => 'true_false',
						'ui'            => 1,
						'default_value' => 0,
					...
					array(
						'key'               => 'field_blue_smtp_email',
						'label'             => __( 'Microsoft 365 mailbox', 'blue-mattress' ),
						'name'              => 'smtp_email',
						'type'              => 'email',
						'instructions'      => __( 'This address is used for authentication and as the From address.', 'blue-mattress' ),
						'conditional_logic' => array( array( array( 'field' => 'field_blue_smtp_enabled', 'operator' => '==', 'value' => '1' ) ) ),
					),
					array(
						'key'               => 'field_blue_smtp_password',
						'label'             => __( 'Mailbox password', 'blue-mattress' ),
						'name'              => 'smtp_password',
						'type'              => 'password',
						'instructions'      => __( 'Leave blank to keep the saved password. For better security, define BLUE_SMTP_PASSWORD in wp-config.php instead of saving it here.', 'blue-mattress' ),
						'conditional_logic' => array( array( array( 'field' => 'field_blue_smtp_enabled', 'operator' => '==', 'value' => '1' ) ) ),
					),
					array(
						'key'               => 'field_blue_smtp_from_name',
						'label'             => __( 'From name', 'blue-mattress' ),
						'name'              => 'smtp_from_name',
						'type'              => 'text',
						'placeholder'       => 'Blue Mattresses',
						'conditional_logic' => array( array( array( 'field' => 'field_blue_smtp_enabled', 'operator' => '==', 'value' => '1' ) ) ),
					),
		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					...
					array( 'key' => 'field_blue_hero_mobile_poster', 'label' => __( 'Hero mobile banner image', 'blue-mattress' ), 'name' => 'hero_mobile_poster', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'instructions' => __( 'Optional portrait or mobile crop. On phones this image replaces the desktop banner and video. Leave empty to use the desktop banner.', 'blue-mattress' ) ),
					array( 'key' => 'field_blue_hero_show_caption', 'label' => __( 'Show banner caption', 'blue-mattress' ), 'name' => 'hero_show_caption', 'type' => 'true_false', 'ui' => 1, 'default_value' => 1, 'instructions' => __( 'Turn off to hide the hero heading, description and buttons while keeping the image or video visible.', 'blue-mattress' ) ),
