		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					...
					array( 'key' => 'field_blue_newsletter_placeholder_en', 'label' => __( 'Newsletter placeholder (English)', 'blue-mattress' ), 'name' => 'newsletter_placeholder_en', 'type' => 'text', 'default_value' => 'Email for sleep stories & offers', 'wrapper' => array( 'width' => 50 ) ),
					array( 'key' => 'field_blue_newsletter_placeholder_ar', 'label' => __( 'Newsletter placeholder (Arabic)', 'blue-mattress' ), 'name' => 'newsletter_placeholder_ar', 'type' => 'text', 'default_value' => 'بريدك لقصص النوم والعروض', 'wrapper' => array( 'width' => 50 ) ),
...
add_action(
	...
	function (): void {
		...
		$options = array(
			...
			'newsletter_placeholder_en'  => 'Email for sleep stories & offers',
			'newsletter_placeholder_ar'  => 'بريدك لقصص النوم والعروض',
