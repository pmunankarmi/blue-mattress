...
$terms_fallback = function_exists( 'wc_get_page_permalink' ) ? wc_get_page_permalink( 'terms' ) : blue_home_url( '/terms-conditions/' );
$terms    = (string) blue_option( 'terms_page', $terms_fallback );
